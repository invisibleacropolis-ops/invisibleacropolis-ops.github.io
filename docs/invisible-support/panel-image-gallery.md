...
- Primary module: `invisible-support/src/features/images/gallery.js`
- Supporting modules:  
  - `invisible-support/src/features/images/store.js` (source data and deletion)  
  - `invisible-support/src/features/images/viewer.js` (selection target and selected-id source)  
  - `invisible-support/src/shared/utils.js` (`formatBytes`)  
  - `invisible-support/src/shared/ui/notifications.js` (`toast` feedback)
