...
This page is the entry point for the `docs/invisible-support/` documentation set. It maps each Home panel in `invisible-support/index.html` to the feature modules that own behavior and state.

## Startup architecture from `invisible-support/src/main.js`
...
## Source-of-truth ownership map (`invisible-support/src/features/**`)
